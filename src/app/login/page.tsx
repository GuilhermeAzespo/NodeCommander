...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-bg-primary text-text-primary flex flex-col items-center justify-center relative overflow-hidden px-4">
      {/* Decorative Blur Backgrounds */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/5 dark:bg-blue-600/10 rounded-full blur-3xl -z-10 pointer-events-none" />
